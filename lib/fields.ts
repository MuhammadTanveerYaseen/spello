...
export const EXPENSE_LIST_FIELDS =
  "title amount category date vendor invoiceName description createdAt";

export const INVESTMENT_LIST_FIELDS =
  "investorId investorName type amount date paymentMethod reference note invoiceName createdAt";
